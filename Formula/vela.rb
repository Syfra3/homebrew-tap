class Vela < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "32dcce09c40daa709602f48a991f05319e746205bd5b912b4e0810742ed4a1ba"
    else
      url "https://github.com/Syfra3/vela/releases/download/v#{version}/vela-#{version}-darwin-amd64.tar.gz"
      sha256 "54b0a3add24c043720c7938d811da030de23d7602aa8222efb0c19415bad6cfe"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "ed8339ec457f782e8f7ab4e398ade82bd7bb6ca36d7c4213d6d70d684cfdef86"
    else
      url "https://github.com/Syfra3/vela/releases/download/v#{version}/vela-#{version}-linux-amd64.tar.gz"
      sha256 "00d19f1865b8e257fe99ba0af81e5418afb90d472eff03fab448abeb25afff85"
    end
  end
